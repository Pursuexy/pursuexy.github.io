  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/gravatar.jpg')
      } else {
        ele.src = 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/image-404.png'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/image-404.png'
  }
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/star.png')
  changeBG('#KAdots-bg', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/point.png')
  changeBG('#totem-bg', 'https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/Pursuexy/files@1.0/images/other/starry_sky.png)')
